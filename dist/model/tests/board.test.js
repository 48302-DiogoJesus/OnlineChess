...
describe('Board Game Tests', () => {
    ...
    describe('Position Tests', () => {
        ...
        test('Invalid String to Position 1', () => {
            expect(expectThrow(position_1.stringToPosition, "i1").message).toBe(model_errors_1.default.INVALID_POSITION_CONVERSION.message);
        });
        test('Invalid String to Position 2', () => {
            expect(expectThrow(position_1.stringToPosition, "a9").message).toBe(model_errors_1.default.INVALID_POSITION_CONVERSION.message);
        });
    ...
    describe('Move Tests', () => {
        ...
        test('Invalid String to Move 1', () => {
            expect(expectThrow(position_1.stringToMove, 'lb2b4').message).toBe(model_errors_1.default.INVALID_MOVE_CONVERSION.message);
        });
        test('Invalid String to Move 2', () => {
            expect(expectThrow(position_1.stringToMove, 'pb9b4').message).toBe(model_errors_1.default.INVALID_POSITION_CONVERSION.message);
        });
    ...
    describe('Board Moves Tests', () => {
        ...
        test('Test king in check', () => {
            var _a;
            const board = new board_1.BoardObject();
            board.setPieceAt((0, position_1.stringToPosition)('d7'), new piece_1.Pawn(piece_1.PieceColor.WHITE));
            expect((_a = board.getPieceAt((0, position_1.stringToPosition)('d7'))) === null || _a === void 0 ? void 0 : _a.toString()).toBe('P');
            expect(board.turn).toBe(piece_1.PieceColor.WHITE);
            board.turn = piece_1.PieceColor.BLACK;
            expect(board.turn).toBe(piece_1.PieceColor.BLACK);
        ...
        test('Test eating king', () => {
            ...
            expect(expectThrow(board.makeMove, "pb2b4").message).toBe(model_errors_1.default.ALREADY_OVER.message);
        });
        test('Test promotion', () => {
            var _a;
            const board = new board_1.BoardObject();
        ...
        test('Valid String to Board', () => {
            var _a, _b;
            const board = (0, board_1.stringToBoard)("rnbqkbnrppKppppp                                P PPPPPPRNBQKBNR");
            expect((_a = board === null || board === void 0 ? void 0 : board.getPieceAt((0, position_1.stringToPosition)("c7"))) === null || _a === void 0 ? void 0 : _a.toString()).toBe("K");
            expect(board === null || board === void 0 ? void 0 : board.getPieceAt((0, position_1.stringToPosition)("b2"))).toBeNull();
            expect((_b = board === null || board === void 0 ? void 0 : board.getPieceAt((0, position_1.stringToPosition)("a2"))) === null || _b === void 0 ? void 0 : _b.toString()).toBe("P");
        });
        test('Invalid String to Board', () => {
            expect(expectThrow(board_1.stringToBoard, "dfgdfa").message).toBe(model_errors_1.default.BAD_BOARD_STRING.message);
        });
        test('String to Board to String to board', () => {
            var _a, _b;
            const board = (0, board_1.stringToBoard)("rnbqkbnrpppppppP                                P PPPPPPRNBQKBNR");
            board.makeMove("pc2c4");
            expect((_a = board === null || board === void 0 ? void 0 : board.getPieceAt((0, position_1.stringToPosition)("c4"))) === null || _a === void 0 ? void 0 : _a.toString()).toBe("P");
            expect((_b = board === null || board === void 0 ? void 0 : board.getPieceAt((0, position_1.stringToPosition)("h7"))) === null || _b === void 0 ? void 0 : _b.toString()).toBe("P");
